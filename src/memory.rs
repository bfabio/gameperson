...
///!    =============================
///!    Interrupts are a break in program code generated by a piece of the hardware
///!    when a certain condition is met. These conditions can be set by the programmer.
///!    There are several different types of interrupts, and when an interrupt is
///!    generated, the program stops where it is, and jumps to one of the specified
...
///!                        |                  |       |   |       |        |    |
///!                                           ⯆
///!    0x8000-0x97ff - Tile RAM (or Character RAM)
///!    ===========================================
...
///!    Each byte in this space represnts an 8x8 pixel space on the display. This area
///!    is 32x32 tiles large... EG: 1024 bytes. The display processor takes each byte
